  ...
  return user ? (
    <ul className="ulhomeListCreate">
      <li className="liconlogin">
        <Link to="/">
          <img src={homePng} alt="homePng" className="icoHome"></img>
        </Link>
        <Link to="/notes">
          <img src={listNotes} alt="listNotesPng" className="icoNotes"></img>
        </Link>
        <Link to="/note">
          <img
            src={createNote}
    ...
    <ul className="ulLoginRegisterHome">
      <li className="lisinlogin">
        ...
        <Link to="/login">
          <img src={loginPng} alt="loginPng" className="icoLogin"></img>
        </Link>
        <Link to="/register">
          <img
            src={registerPng}
